            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 text-end">
                        <a href="{{ route('internal.page.training-evaluation.index') }}" class="btn btn-primary">Kembali</a>
                    </div>
                    @if ($training->count())
                            ...
                            <table id="myTable" class="table table-striped nowrap">
                                <thead class="text-dark fs-4">
                                    <tr>
                                        ...
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0" style="text-align: center"> Nilai Pre Test
                                            </h6>
                                        </th>
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0" style="text-align: center"> Nilai Post Test
                                            </h6>
                                        </th>
                                        <th>
                                    ...
                                    @forelse ($participantsWithScores as $index => $participant)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <p class="mb-0 fs-2 fw-normal">{{ $participant->pre_test }} / 100</p>
                                            </td>
                                            <td class="text-center">
                                                <p class="mb-0 fs-2 fw-normal">{{ $participant->post_test }} / 100</p>
                                            </td>
                                            <td class="text-center">
