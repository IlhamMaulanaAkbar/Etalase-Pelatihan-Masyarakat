            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 text-end">
                        <a href="{{ route('internal.evaluations.training-evaluation.index', ['training' => $training->id]) }}"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form
                                action="{{ route('internal.evaluations.training-evaluation.update', ['training' => $training->id, 'training_evaluation' => $question->id]) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
