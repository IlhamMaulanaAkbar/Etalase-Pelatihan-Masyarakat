...
@section('content')
    <main>
        <section>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Peserta Pelatihan: <br>{{ $training->training_name }}</h5>
                    <div class="mb-3 text-end">
                        <a href="{{ route('internal.training.participants.index') }}" class="btn btn-primary">Kembali</a>
                    </div>
                            ...
                            <table id="myTable" class="table table-striped nowrap">
                                <thead class="text-dark fs-4">
                                    <tr>
                                        ...
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0">Surat Rekomendasi</h6>
                                        </th>
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0">Surat Pernyataan</h6>
                                        </th>
                                        <th>
                    ...
                    @else
                        <div class="alert alert-info mb-0">
                            Belum ada peserta pelatihan yang mendaftar.
                        </div>
                    @endif
                </div>
            </div>
