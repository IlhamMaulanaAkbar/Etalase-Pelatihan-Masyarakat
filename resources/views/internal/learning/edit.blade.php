                            ...
                            <form action="{{ route('internal.learning.update', ['learning' => $learning]) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="type" name="type">
                                        ...
                                        <option value="umum" {{ old('type', $learning->type) == 'umum' ? 'selected' : '' }}>Umum</option>
                                        <option value="pelatihan" {{ old('type', $learning->type) == 'pelatihan' ? 'selected' : '' }}>Pelatihan</option>
                                        <option value="pendampingan" {{ old('type', $learning->type) == 'pendampingan' ? 'selected' : '' }}>Pendampingan</option>
                                        <option value="pengumuman" {{ old('type', $learning->type) == 'pengumuman' ? 'selected' : '' }}>Pengumuman</option>
                                    </select>
                                    @error('type')
                                        <div class="text-danger">
                                            {{ $message }}
