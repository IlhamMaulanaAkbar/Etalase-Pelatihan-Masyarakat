...
<body>
    ...
    <h3 class="title">Laporan Peserta Pelatihan</h3>
        ...
        <tbody>
            ...
            @foreach ($participants as $index => $participant)
                <tr>
                    ...
                    <td>{{ $participant->training->training_name }}</td>
                    <td>{{ $participant->training->category->name }}</td>
                    <td>{{ $participant->pre_test_score }}</td>
                    <td>{{ $participant->post_test_score }}</td>
