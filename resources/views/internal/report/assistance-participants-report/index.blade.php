    ...
    <main>
        <section>
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('internal.report.assistance-participants-report.print', request()->query()) }}" target="_blank"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="GET" class="row g-2 mb-4 d-flex justify-content-center">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('internal.report.assistance-participants-report.index') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="mb-0 fs-2 fw-normal">
                                                    {{ $participant->assistance->assistance_name }}</p>
                                            </td>
                                            <td>
                                                <p class="mb-0 fs-2 fw-normal">
                                                    {{ $participant->assistance->training->training_name }}</p>
                                            </td>
                                            <td>
