...
<head>
    <title>Laporan Peserta Pendampingan</title>
    <style>
        @page {
...
<body>
    ...
    <h3 class="title">Laporan Peserta Pendampingan</h3>
        ...
        <tbody>
            ...
            @foreach ($participants as $index => $participant)
                <tr>
                    ...
                    <td>{{ $participant->assistance->assistance_name }}</td>
                    <td>{{ $participant->assistance->training->training_name }}</td>
                    <td>{{ strtoupper($participant->status) }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
