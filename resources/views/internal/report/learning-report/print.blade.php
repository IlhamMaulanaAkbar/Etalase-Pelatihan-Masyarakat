...
<head>
    <title>Laporan Video Pembelajaran</title>
    <style>
        @page {
...
<body>
    ...
    <h3 class="title">Laporan Video Pembelajaran</h3>
    ...
    <table>
        ...
        <tbody>
            ...
            @foreach ($learnings as $index => $learning)
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td>{{ $learning->video_name }}</td>
                    <td>{{ ucfirst(strtolower($learning->type)) }}</td>
                    <td>{{ $learning->video_url }}</td>
                    <td>{{ Carbon::parse($learning->uploaded_at)->translatedFormat('d F Y') }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
