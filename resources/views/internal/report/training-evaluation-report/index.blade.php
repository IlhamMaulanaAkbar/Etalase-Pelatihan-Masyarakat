    ...
    <main>
        <section>
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('internal.report.training-evaluations-report.print', request()->query()) }}" target="_blank"
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Laporan Evaluasi Pelatihan</h5>
                    <form method="GET" class="row g-2 mb-4 d-flex justify-content-center">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('internal.report.training-evaluations-report.index') }}"
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0" style="text-align: center"> Nilai Rata - Rata
                                                Pre Test <br> Peserta</h6>
                                        </th>
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0" style="text-align: center"> Nilai Rata - Rata
                                                Post Test <br> Peserta</h6>
                                        </th>
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0" style="text-align: center"> Nilai Rata - Rata
                                                Evaluasi</h6>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <p class="mb-0 fs-2 fw-normal">
                                                    {{ number_format($training->average_pretest) }} / 100</p>
                                            </td>
                                            <td class="text-center">
                                                <p class="mb-0 fs-2 fw-normal">
                                                    {{ number_format($training->average_posttest) }} / 100</p>
                                            </td>
                                            <td class="text-center">
                                                <p class="mb-0 fs-2 fw-normal">
