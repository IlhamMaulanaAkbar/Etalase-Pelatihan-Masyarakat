...
<body>
    ...
    <h3 class="title">Laporan Evaluasi Pelatihan</h3>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Nilai Rata - rata Pre Test</th>
                <th>Nilai Rata - rata Post Test</th>
                <th>Nilai Rata - rata Evaluasi</th>
                <th>Total Peserta</th>
            </tr>
        </thead>
        <tbody>
            ...
            @foreach ($trainings as $index => $training)
                <tr>
                    ...
                    <td>{{ number_format($training->average_pretest) }} / 100</td>
                    <td>{{ number_format($training->average_posttest) }} / 100</td>
                    <td>{{ number_format($training->average_evaluation, 1) }} / 5</td>
