...
<head>
    <title>Laporan Evaluasi Instruktur Pelatihan</title>
    <link rel="icon" type="image/png" href="{{ public_path('assets/images/logos/logo.png') }}">
    <style>
        @page {
...
<body>
    ...
    <h3 class="title">Laporan Evaluasi Instruktur Pelatihan</h3>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Nilai Rata - rata Evaluasi Instruktur</th>
                <th>Total Peserta</th>
            </tr>
        </thead>
        <tbody>
