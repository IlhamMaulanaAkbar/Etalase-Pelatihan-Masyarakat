    ...
    <main>
        <section>
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('internal.report.training-report.print', request()->query()) }}" target="_blank" class="btn btn-danger btn-sm mb-3 me-2"><i class="ti ti-printer fs-2"></i>
                    Cetak PDF
                </a>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="GET" class="row mb-4 g-2 d-flex justify-content-center">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('internal.report.training-report.index') }}"
                            ...
                            <table id="myTable" class="table table-striped nowrap">
                                <thead class="text-dark fs-4">
                                    <tr>
                                        ...
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0">Status Pelatihan</h6>
                                        </th>
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0">Lokasi Pelatihan</h6>
                                        </th>
                                        <th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="mb-0 fs-2 fw-normal">
                                                    {{ $training->deadline_date->format('d M Y') }}
                                                </p>
                                            </td>
                                            <td>
                                                <p class="mb-0 fs-2 fw-normal">{{ $training->status }}
                                                </p>
                                            </td>
                                            <td>
                                                <p class="mb-0 fs-2 fw-normal">{{ $training->location }}</p>
                                            </td>
                                            <td>
                                                <p class="mb-0 fs-2 fw-normal">{{ $training->target_audience }}</p>
                                            </td>
                                            <td>
                                                <p class="mb-0 fs-2 fw-normal">{{ $training->training_users_count }}</p>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
