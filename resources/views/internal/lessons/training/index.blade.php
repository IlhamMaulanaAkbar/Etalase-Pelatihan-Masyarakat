...
@section('content')
    <main>
        <section>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Materi Pelatihan</h5>
                    <div class="mb-3 text-end">
                        <a href="{{ route('internal.lessons.training.create', ['training' => $training->id]) }}"
                            class="btn btn-primary">Tambah Materi Pelatihan</a>
                    </div>
                    @if (sizeof($lessons) > 0)
                            ...
                            <table id="myTable" class="table table-striped nowrap">
                                <thead class="text-dark fs-4">
                                    <tr>
                                        ...
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0">Nama Materi Pelatihan</h6>
                                        </th>
                                        <th class="text-center">
                                            <h6 class="fs-2 fw-semibold mb-0">File Materi Pelatihan</h6>
                                        </th>
                                        <th class="text-center">
                                            <h6 class="fs-2 fw-semibold mb-0">Durasi Materi Pelatihan</h6>
                                        </th>
                                        <th class="text-center">
                                ...
                                <tbody>
                                    @foreach ($lessons as $lesson)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('internal.lessons.training.edit', ['training' => $training->id, 'lesson' => $lesson->id]) }}"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                Apakah Anda yakin ingin menghapus materi pelatihan ini?
                                                            </div>
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('internal.lessons.training.destroy', ['training' => $training->id, 'lesson' => $lesson->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
