            ...
            <div class="card">
                <div class="card-body">
                    <div class="container py-4">
                        <h5 class="card-title fw-semibold mb-4">Halaman Post-Test</h5>

                        {{-- Tombol Tambah Pertanyaan --}}
                        <div class="rounded p-4 mb-4 text-center" style="border-style: dashed; border-color: #000; border-width: 2px;">
                            <a href="{{ route('internal.test-assessment.post-test.create', ['training' => $training->id]) }}"
                        ...
                        @forelse($questions as $question)
                            <div
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <a href="{{ route('internal.test-assessment.post-test.edit', ['training' => $training->id, 'post_test' => $question->id]) }}"
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm rounded-pill" data-bs-toggle="modal"
                                        ...
                                        data-action="{{ route('internal.test-assessment.post-test.destroy', ['training' => $training->id, 'post_test' => $question->id]) }}">
                            ...
                            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel"
                                ...
                                <div class="modal-dialog">
                                    <form method="POST" id="deleteForm"
                                        action="{{ route('internal.test-assessment.post-test.destroy', ['training' => $training->id, 'post_test' => $question->id]) }}">
                                        @csrf
                                        @method('DELETE')
