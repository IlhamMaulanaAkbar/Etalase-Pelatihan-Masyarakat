                        ...
                        @forelse($questions as $question)
                            <div
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <a href="{{ route('internal.test-assessment.pre-test.edit', ['training' => $training->id, 'pre_test' => $question->id]) }}"
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm rounded-pill" data-bs-toggle="modal"
                                        ...
                                        data-action="{{ route('internal.test-assessment.pre-test.destroy', ['training' => $training->id, 'pre_test' => $question->id]) }}">
                            ...
                            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <form method="POST" id="deleteForm" action="{{ route('internal.test-assessment.pre-test.destroy', ['training' => $training->id, 'pre_test' => $question->id]) }}">
                                        @csrf
                                        @method('DELETE')
