...
@section('content')
    <main>
        <section>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Jadwal Pelatihan</h5>
                    <div class="mb-3 text-end">
                        <a href="{{ route('internal.schedules.training.create', ['training' => $training->id]) }}"
                            class="btn btn-primary">Tambah Jadwal Pelatihan</a>
                    </div>
                            ...
                            <table id="myTable" class="table table-striped nowrap">
                                <thead class="text-dark fs-4">
                                    <tr>
                                        ...
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0">Pertemuan</h6>
                                        </th>
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0">Tanggal</h6>
                                        </th>
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0">Waktu</h6>
                                        </th>
                                        <th>
                                            <h6 class="fs-2 fw-semibold mb-0">Judul Materi</h6>
                                        </th>
                                        <th class="text-center">
                                            <h6 class="fs-2 fw-semibold mb-0">Narasumber</h6>
                                        </th>
                                        <th class="text-center">
                                            <h6 class="fs-2 fw-semibold mb-0">File</h6>
                                        </th>
                                        <th class="text-center">
                                ...
                                <tbody>
                                    @foreach ($schedules as $schedule)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="mb-0 fs-2 fw-normal">{{ $schedule->meeting_number }}</p>
                                            </td>
                                            <td>
                                                <p class="mb-0 fs-2 fw-normal">{{ $schedule->date->format('d M Y') }}</p>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('internal.schedules.training.show', ['training' => $training->id, 'schedule' => $schedule->id]) }}"
                                                    class="btn btn-secondary btn-sm"><i class="ti ti-eye"></i></a>

                                                <a href="{{ route('internal.schedules.training.edit', ['training' => $training->id, 'schedule' => $schedule->id]) }}"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('internal.schedules.training.destroy', ['training' => $training->id, 'schedule' => $schedule->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
