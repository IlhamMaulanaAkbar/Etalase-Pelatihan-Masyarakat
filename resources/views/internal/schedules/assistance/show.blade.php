...
@section('content')
    <main>
        <section>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-3">Detail Jadwal Pendampingan</h5>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <p class="text-muted mb-1">Pendampingan</p>
                            <p class="fw-semibold mb-0">{{ $assistance->assistance_name }}</p>
                        </div>
                        <div class="col-md-6 mb-3">
                                ...
                                <tbody>
                                    @foreach ($attendedParticipants as $participant)
                                        ...
                                        <tr>
                                            ...
                                            <td><p class="mb-0 fs-2 fw-normal">{{ $attendance?->note ?? '-' }}</p></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
