...
@section('content')
    <main>
        <section>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Edit Jadwal Pendampingan</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form
                                action="{{ route('internal.schedules.assistance.update', ['assistance' => $assistance->id, 'schedule' => $schedule->id]) }}"
