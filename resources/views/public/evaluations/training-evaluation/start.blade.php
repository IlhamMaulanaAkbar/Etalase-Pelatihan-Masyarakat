                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-center">
                            <h5 class="mt-3 fw-semibold">Evaluasi - Pelatihan {{ $training->id }}</h5>
                        ...
                        <div class="col-md-6">
                            <div class="bg-light-primary p-5 rounded border">
                                ...
                                <!-- Tombol Mulai -->
                                <a href="{{ route('public.evaluations.training.ongoing', ['training' => $training->id]) }}"
                                    class="btn btn-primary w-100 rounded-pill">
                                    ▶ MULAI EVALUASI PELATIHAN
                                </a>
                            </div>
                        </div>
                    </div>
