...
@section('content')
    <section class="bg-white py-5">
        <div class="container">
            ...
            <form action="{{ route('public.evaluations.training.submit', ['training' => $training->id]) }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-9 ps-4">
                                        ...
                                        @foreach ($question->answers as $index => $answer)
                                            <div class="form-check">
                                                <input class="form-check-input answer-option" type="radio"
                                                    ...
                                                    value="{{ $index + 1 }}" data-question-id="{{ $question->id }}"> {{-- Kirim 1 sampai 5 --}}
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4" id="navigationRow">
                            ...
                            <div class="d-flex gap-2" id="nextContainer">
                                ...
                                <div class="text-end" id="submitWrapper" data-bs-toggle="tooltip"
