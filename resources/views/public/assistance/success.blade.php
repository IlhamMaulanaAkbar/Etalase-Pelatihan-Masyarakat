        ...
        <div class="border border-1 rounded p-4" style="max-width: 500px; width: 100%;">
            <div class="text-center">
                ...
                <p class="mb-4">
                    ...
                    Pendampingan melalui Email/SMS/WA.
                </p>

                {{-- Countdown --}}
                <p class="text-muted mb-0">Kembali menuju halaman Pendampingan dalam</p>
                <p class="fw-semibold">
                    <span id="countdown">01:00</span> atau
                    <a id="startTestLink"
                        href="{{ route('public.assistance.show', ['assistance' => $assistance->id]) }}"
                ...
                if (seconds <= 0) {
                    ...
                    if (!linkClicked) {
                        window.location.href =
                            "{{ route('public.assistance.show', ['assistance' => $assistance->id]) }}";
                    }
                }
            }, 1000);
        });
