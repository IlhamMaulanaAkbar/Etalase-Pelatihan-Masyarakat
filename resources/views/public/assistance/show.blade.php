@php
    $isRegistered = $assistance->assistance_users->where('user_id', $user?->id)->first();
    $kuotaPenuh = $assistance->assistance_users->count() >= $assistance->target_audience;
    $now = now();
    ...
    $statusClass = match ($assistance->status) {
        'BUKA' => 'success',
        'SELESAI' => 'primary',
        'TUTUP' => 'danger',
    };
...
@section('content')
    <section class="bg-white">
        <div class="container py-5">
            ...
            <div class="bg-primary text-white p-4 rounded mb-4">
                <h2 class="fw-bolder text-white mt-2">{{ $assistance->assistance_name }}</h2>
                <p>Lulusan {{ $assistance->training->training_name }}</p>

                <div class="row g-3">
                    <div class="col-md-4 d-flex align-items-center">
                        <div>
                            <div class="fw-semibold">Tgl. Pendampingan</div>
                            <div><i class="ti ti-calendar-event me-2 fs-4"></i>{{ $assistance->start_date->format('d M Y') }}
                                -
                                {{ $assistance->end_date->format('d M Y') }}</div>
                        </div>
                    </div>
                    <div class="col-md-4 d-flex align-items-center">
                        <div>
                            <div class="fw-semibold">Lokasi</div>
                            <div><i class="ti ti-map-pin me-2 fs-4"></i>{{ $assistance->location }}</div>
                        </div>
                    </div>
                    <div class="col-md-4 d-flex align-items-center">
                        <div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="tab-content" id="detailTabsContent">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex align-items-center social-user gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div>{{ $assistance->target_audience }} Orang</div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="silabus" role="tabpanel">
                            <p class="fw-semibold text-black mb-4">Jadwal Pendampingan ({{ $totalJp }} JP)</p>
                            ...
                            <div class="position-relative ms-4">
                                                ...
                                                <div class="modal-content rounded-3">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        @if ($schedule->material_description)
                                                            <div class="mt-3">
                                                                <div class="fw-semibold">Deskripsi Materi</div>
                                                        ...
                                                        @else
                                                            <form method="POST"
                                                                action="{{ route('public.assistance.attendance.store', [$assistance, $schedule]) }}">
                                                                @csrf
                                                                <div class="mb-3">
                                ...
                                @empty
                                    <div class="border-top border-bottom py-4 text-center">
                                        <p class="mb-0">Tidak ada Jadwal Pendampingan Yang Tersedia.</p>
                                    </div>
                                @endforelse
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="peserta" role="tabpanel">
                            <div id="participants-wrapper">
                                @include('public.assistance.participants', [
                    ...
                    <div id="form-pendaftaran-wrapper" class="d-none">
                        ...
                        <div id="formPendaftaranSection" class="bg-light p-4 rounded">
                            <h4 class="fw-semibold mb-3">Form Pendaftaran Pendampingan</h4>
                            <div class="alert alert-primary border border-primary" role="alert">
                                <strong>Perhatian!</strong><br>
                                Sebelum melakukan pendaftaran, pastikan anda berkomitmen untuk mengikuti pendampingan ini dengan sungguh-sungguh hingga selesai, sesuai jadwal dan ketentuan yang berlaku.
                            </div>

                            <form id="formPendaftaran" method="POST"
                                action="{{ route('public.assistance.register', $assistance) }}"
                        ...
                        <div id="form-komitmen" class="d-none bg-light p-4 rounded">
                            <h4 class="fw-semibold mb-1">Form Komitmen</h4>
                            <p>Saya akan berkomitmen dalam mengikuti pendampingan ini.</p>

                            <div class="form-check mb-3">
                                <input type="checkbox" class="form-check-input" id="komitmenCheck">
                                <label class="form-check-label" for="komitmenCheck">
                                    Saya bersedia mengikuti seluruh kegiatan pada pendampingan ini.
                                </label>
                    ...
                    <div class="border rounded p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h5 class="fw-bolder text-black">{{ $assistance->deadline_date->format('d M Y') }}</h5>
                            </div>
                            <span class="badge bg-{{ $statusClass }} rounded-pill px-4 py-2 fs-2">
                                {{ ucfirst(strtolower($assistance->status)) }}
                            </span>
                        </div>
                        <div class="mt-2">
                            {{-- Jika belum login --}}
                            @guest('user')
                                ...
                                @elseauth('user')
                                {{-- Cek status Pendampingan --}}
                                @if ($assistance->status === 'SELESAI')
                                    <button class="btn btn-secondary w-100 rounded-pill fw-bold py-2" disabled>
                                        Pendampingan Telah Selesai
                                    </button>
                                @elseif ($kuotaPenuh || $assistance->status === 'TUTUP' || $now->gt($assistance->deadline_date))
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-2 d-flex align-items-center border-bottom pb-2">
                                    <i class="ti ti-user me-2"></i> Kuota <span
                                        class="ms-auto text-muted">{{ $assistance->target_audience }}
                                        orang</span>
                                </li>
                                <li class="mb-2 d-flex align-items-center border-bottom pb-2">
                                ...
                                <li class="mb-2 d-flex align-items-center border-bottom pb-2">
                                    ...
                                    <div class="d-flex w-100 align-items-center">
                                        <div class="flex-grow-1">Lokasi Pendampingan</div>
                                        <div class="text-muted text-end" style="max-width: 55%; word-break: break-word;">
                                            {{ $assistance->location }}
                                        </div>
                                    </div>
                                ...
                                <li class="mb-2 d-flex align-items-center border-bottom pb-2">
                                    <i class="ti ti-calendar-event me-2"></i> Tgl. Mulai Pendampingan <span
                                        class="ms-auto text-muted">{{ $assistance->start_date->format('d M Y') }}</span>
                                </li>
                                <li class="mb-2 d-flex align-items-center border-bottom pb-2">
                                    <i class="ti ti-calendar-event me-2"></i> Tgl. Selesai Pendampingan <span
                                        class="ms-auto text-muted">{{ $assistance->end_date->format('d M Y') }}</span>
                                </li>
                                <li class="mb-2 d-flex align-items-center border-bottom pb-2">
                                ...
                                <li class="mb-2 d-flex align-items-center border-bottom pb-2">
                                    <i class="ti ti-eye me-2"></i> Dilihat sebanyak <span
                                        class="ms-auto text-muted">{{ $assistance->views }}</span>
                                </li>
                            </ul>
    ...
    <div class="modal fade" id="shareModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-3">
                <div class="modal-header">
                    <h5 class="modal-title">Bagikan Pendampingan ini!</h5>
    ...
    <div class="modal fade" id="modalKonfirmasiDaftar" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 p-4 text-center">
                ...
                <p class="mb-4 fw-normal">Dengan melanjutkan pendaftaran, saya menyatakan siap mengikuti kegiatan pendampingan secara aktif dan bertanggung jawab.
                </p>
